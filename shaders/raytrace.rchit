...
void main() {
    //payload.hitValue = materialBuffer.data[materialIndexBuffer.data[gl_PrimitiveID]].diffuse;
   ...
   // payload.hitValue = v0.color * barycentric.x + v1.color * barycentric.y + v2.color * barycentric.z;
}
