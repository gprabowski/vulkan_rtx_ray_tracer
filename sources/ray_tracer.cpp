...
VkSurfaceFormatKHR RayTracerApp::chooseSwapSurfaceFormat(
...
VkPresentModeKHR RayTracerApp::chooseSwapPresentMode(
...
void RayTracerApp::setupDebugMessenger() {
  ...
  if (ExtFun::CreateDebugUtilsMessengerEXT(instance, &createInfo, nullptr,
...
void RayTracerApp::drawRasterFrame() {
  ...
  VkPipelineStageFlags waitStages[] = {
      // means that stage of writing to the color
...
void RayTracerApp::populateDebugMessengerCreateInfo(
    VkDebugUtilsMessengerCreateInfoEXT &createInfo) {
  createInfo = {};
...
RayTracerApp::debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
